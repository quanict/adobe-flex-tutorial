...
Welcome to Adobe Flex Tutorial's documentation!
===============================================
...
.. toctree::
    ...
    intro/overview
    intro/environment
    application/flex_applications
    style/flex_style
    form/flex_form

    control/flex_image_control

    java/architecture

Flex is a powerful, open source application framework that allows you to build mobile applications for iOS,
Android, and BlackBerry Tablet OS devices, 
as well as traditional applications for browsers and desktops using the same programming model, tool, and codebase.
